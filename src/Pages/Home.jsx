    ...
    <Suspense fallback="Cargando informacion">
      <div className="relative font-Lato text-black transition-all duration-500 dark:bg-black dark:text-White">
        <section className="Container m-auto w-[90%] overflow-hidden transition-all duration-500">
          ...
          {/* Listas de los servicios y recursos */}
          <Informacion
            title={t("Services.title")}
            extra={
              <section className="mb-4 flex flex-col gap-4 lg:flex-row lg:items-stretch text-xl">
                {/* Contenedor izquierdo */}
                <div className="flex-1 overflow-hidden rounded-xl bg-Atlantis min-h-[400px] dark:bg-Blue-Dianne">
                  <h2 className="bg-Sycamore p-2 text-center text-White dark:bg-gray-800">
                    {t("Services.title2")}
                  </h2>
                  <ul className="list-decimal text-center text-White">
                    <li className="py-5">{t("Services.s1")}</li>
                    <li className="py-5">{t("Services.s2")}</li>
                    <li className="py-5">{t("Services.s3")}</li>
                    <li className="py-5">{t("Services.s4")}</li>
                    <li className="py-5">{t("Services.s5")}</li>
                    <li className="py-5">{t("Services.s6")}</li>
                  </ul>
                </div>
                ...
                <div className="flex-1 overflow-hidden rounded-xl bg-Atlantis min-h-[400px] dark:bg-Blue-Dianne">
                  ...
                  <ul className="list-decimal text-center text-White">
                    <li className="py-2">{t("Services.r1")}</li>
                    <li className="py-2">{t("Services.r2")}</li>
                    <li className="py-2">{t("Services.r3")}</li>
                    <li className="py-2">{t("Services.r4")}</li>
                    <li className="py-2">{t("Services.r5")}</li>
                    <li className="py-2">{t("Services.r6")}</li>
                    <li className="py-2">{t("Services.r7")}</li>
                    <li className="py-2">{t("Services.r8")}</li>
                    <li className="py-2">{t("Services.r9")}</li>
                    <li className="py-2">{t("Services.r10")}</li>
                  </ul>
                </div>
              </section>
            }

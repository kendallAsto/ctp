...
function UP() {
  ...
  return (
    <Suspense fallback="Cargando datos">
      <section className="flex flex-wrap md:w-[70%] m-auto">
        <section>
          <h1 className="text-3xl font-bold font-Poppins text-Atlantis lg:text-4xl">{t("Danger.title")}</h1>
          <div className="bg-Sycamore text-White p-4 rounded-xl">
          <p className="text-2xl md:text-2xl text-pretty mb-3">{t("Danger.p1")}</p>
          <p className="text-2xl md:text-2xl text-pretty mb-3">{t("Danger.p2")}</p>
          <p className="text-2xl md:text-2xl text-pretty mb-3">{t("Danger.p3")}</p>
          <p className="text-2xl md:text-2xl text-pretty mb-3">{t("Danger.p4")}</p>
          <p className="text-2xl md:text-2xl text-pretty mb-3">{t("Danger.p5")}</p>
          </div>
        </section>

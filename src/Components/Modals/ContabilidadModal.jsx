          ...
          <div>
            <table className="m-4 rounded-xl overflow-hidden">
              ...
              <tr className="text-center bg-Atlantis text-white">
                ...
                <td className="py-2 px-12">{Contabilidad.Total.Decimo} </td>
                <td className="py-2 px-12">{Contabilidad.Total.Undecimo} </td>
                <td className="py-2 px-12">{Contabilidad.Total.Duodecimo} </td>
              </tr>
            </table>
          </div>

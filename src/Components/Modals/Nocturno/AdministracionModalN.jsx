...
import Administracion from "../../../JSON/Nocturno/Administracion.json";
import { useTranslation } from "react-i18next";

export default function AdministracionModalN({ estado, cambiarEstado }) {
          ...
          <div className="relative w-[98%] h-[98%] py-2 overflow-y-auto bg-white rounded-xl p-8 md:h-[80%] md:w-[80%] dark:border-2 dark:bg-black">
            ...
            <section className="m-auto my-12 flex w-[100%] flex-col justify-center gap-4 text-lg lg:w-[100%] lg:flex-row lg:text-xl">
              <div className="overflow-hidden rounded-xl">
                <table className="overflow-hidden rounded-xl md:m-4">
                    ...
                    <tbody className="text-center">
                      {Administracion.Subarea.map((subarea, index) => (
                        <tr key={index}>
                    ...
                    <tr className="bg-Blue-Dianne text-center text-white">
                      ...
                      <td className="md:px-12 md:py-2">
                        {Administracion.Total.Decimo}
                      </td>
                      <td className="md:px-12 md:py-2">
                        {Administracion.Total.Undecimo}
                      </td>
                      <td className="md:px-12 md:py-2">
                        {Administracion.Total.Duodecimo}
                      </td>
                    </tr>
                  </table>
              </div>
              <div className="overflow-hidden rounded-xl">
                  ...
                  <ul>
                    {Administracion.posiblesPuestos.map((puesto, index) => (
                      <li
              ...
              <div className="overflow-hidden rounded-xl">
                ...
                <ul>
                  {Administracion.posiblesEmpresas.map((empresa, index) => (
                    <li
                      className="my-4 rounded-xl bg-Blue-Dianne px-6 py-1 text-white md:p-2"
                      key={index}
                    >
              ...
              <i
                ...
                class="fa-sharp fa-solid fa-xmark absolute right-1 top-1 cursor-pointer rounded-full px-6 py-1 text-4xl hover:bg-Blue-Dianne hover:text-White md:right-12 md:top-4 md:p-2 md:text-5xl dark:text-emerald-300 dark:hover:text-white"
              ></i>
            </div>
        </section>
      )}

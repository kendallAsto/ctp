              ...
              <div>
                <table className="overflow-hidden rounded-xl md:m-4">
                  ...
                  <tr className="bg-Blue-Dianne text-center text-white">
                    ...
                    <td className="md:px-12 md:py-2">{CyS.Total.Decimo} </td>
                    <td className="md:px-12 md:py-2">{CyS.Total.Undecimo} </td>
                    <td className="md:px-12 md:py-2">{CyS.Total.Duodecimo} </td>
                  </tr>
                </table>
              </div>

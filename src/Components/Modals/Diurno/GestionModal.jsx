...
import Gestion from "../../../JSON/Diurno/Gestion_es.json";
          ...
          <div className="relative w-[98%] h-[98%] py-2 overflow-y-auto bg-white rounded-xl p-8 md:h-[80%] md:w-[80%] dark:border-2 dark:border-White dark:bg-black">
            ...
            <section className="m-auto my-12 flex w-[100%] flex-col justify-center gap-4 text-lg lg:w-[100%] lg:flex-row lg:text-xl">
              ...
              <i
                ...
                class="fa-sharp fa-solid fa-xmark absolute right-1 top-1 cursor-pointer rounded-full px-6 py-1 text-4xl hover:bg-Atlantis hover:text-White md:right-12 md:top-4 md:p-2 md:text-5xl dark:text-white"
              ></i>
            </section>
          </div>
        </section>

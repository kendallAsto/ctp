...
import Contabilidad from "../../../JSON/Diurno/Contabilidad_es.json";
              ...
              <div className="overflow-hidden rounded-xl">
                <table className="overflow-hidden rounded-xl md:m-4">
                  ...
                  <tr className="bg-Atlantis text-center text-white">
                    ...
                    <td className="md:px-12 md:py-2">{Contabilidad.Total.Decimo}</td>
                    <td className="md:px-12 md:py-2">{Contabilidad.Total.Undecimo}</td>
                    <td className="md:px-12 md:py-2">{Contabilidad.Total.Duodecimo}</td>
                  </tr>
                </table>
              </div>
              <div className="overflow-hidden rounded-xl">

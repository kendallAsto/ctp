...
import Electronica from "../../../JSON/Diurno/Electronica_es.json";
import { useTranslation } from "react-i18next";

export default function ElectronicaModal({ estado, cambiarEstado }) {
  const { t } = useTranslation("Electronica");
      ...
      {estado && (
        <section className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(0,0,0,.7)]">
          <div className="relative w-[98%] h-[98%] py-2 overflow-y-auto bg-white rounded-xl p-8 md:h-[80%] md:w-[80%] dark:border-2 dark:border-White dark:bg-black">
            <h1 className="p-2 py-5 text-center text-3xl font-bold text-Sycamore md:p-4 md:text-4xl">
              {t("title")}
            </h1>

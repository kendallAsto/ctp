...
import Ejecutivo from "../../../JSON/Diurno/Ejecutivo_es.json";
import { useTranslation } from "react-i18next";

export default function EjecutivoModal({ estado, cambiarEstado }) {
  const { t } = useTranslation("Ejecutivo");
              ...
              <div className="overflow-hidden rounded-xl">
                <table className="overflow-hidden rounded-xl md:m-4">
                  ...
                  <tr className="bg-Atlantis text-center text-white">
                    ...
                    <td className="md:px-12 md:py-2">{Ejecutivo.Total.Decimo}</td>
                    <td className="md:px-12 md:py-2">{Ejecutivo.Total.Undecimo}</td>
                    <td className="md:px-12 md:py-2">{Ejecutivo.Total.Duodecimo}</td>
                  </tr>
                </table>
              </div>
              <div className="overflow-hidden rounded-xl">
